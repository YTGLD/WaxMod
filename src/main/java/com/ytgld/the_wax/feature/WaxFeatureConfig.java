...
public record WaxFeatureConfig(int number, Identifier blockId) implements FeatureConfiguration {
    public static final Codec<WaxFeatureConfig> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                            ...
                            Identifier.CODEC.fieldOf("blockID").forGetter(WaxFeatureConfig::blockId))
