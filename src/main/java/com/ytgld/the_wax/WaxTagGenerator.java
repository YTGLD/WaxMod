...
public class WaxTagGenerator extends ItemTagsProvider { // Temporarily disabled due to API compatibility issues
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        tag(ItemTags.PLANKS)
                .add(BuiltInRegistries.ITEM.get(new ResourceLocation(WaxMod.MOD_ID,"wax")))
                .add(BuiltInRegistries.ITEM.get(new ResourceLocation(WaxMod.MOD_ID,"wax_vine_pipe")))
                .add(BuiltInRegistries.ITEM.get(new ResourceLocation(WaxMod.MOD_ID,"water_wax")))
                .add(BuiltInRegistries.ITEM.get(new ResourceLocation(WaxMod.MOD_ID,"huge_pipe")))

        ;
        tag(PIPE)
                .add(BuiltInRegistries.ITEM.get(new ResourceLocation(WaxMod.MOD_ID,"wax_vine_pipe")))
                .add(BuiltInRegistries.ITEM.get(new ResourceLocation(WaxMod.MOD_ID,"huge_pipe")))
                .add(BuiltInRegistries.ITEM.get(new ResourceLocation(WaxMod.MOD_ID,"pipe_wall")))
